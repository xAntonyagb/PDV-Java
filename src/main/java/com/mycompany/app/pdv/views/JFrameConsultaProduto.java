...
public class JFrameConsultaProduto extends javax.swing.JFrame {
    ...
    private void btConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btConfirmarActionPerformed
        try {
            String descontoText = FieldFormatterUtil.ajustaNumberInput(jTextFieldDesconto.getText());
            String qtdText = FieldFormatterUtil.ajustaNumberInput(jTextFieldQtd.getText());
            String vlUnitText = FieldFormatterUtil.ajustaNumberInput(jTextPaneVlUnit.getText());
            ...
            if (desconto > 100) {
                throw new ValidationException("O máximo de desconto possivel é 100%");
            }
            if (qtd < 1) {
                throw new ValidationException("A quantidade minima é 1");
            }
            if(vlUnit <= 0) {
                throw new ValidationException("O valor unitário deve ser maior que 0.0");
            }
